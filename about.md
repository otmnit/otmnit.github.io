...
- 🌐 *IPv6 for IoT: DHCPv6, RA, and Edge Gateways*  
- ⚡ *XDP vs iptables: Why eBPF Wins Every Time*  
- ☁ *Cloud Networking: VPC Routing Deep Dive*

🔗 Read the blog ➜ **https://otmnit.github.io**
...
**Cloud:** AWS (VPC, IAM, EC2, LB), Hybrid Architecture  
**Linux:** Debian, namespaces, nftables, tc, systemd  
**Programming:** Python, Flask, Bash  
**Tools:** GNS3, EVE-NG, Docker, Wireshark  
...
- CCNP ENCOR  
- IoTBox enhancements  
- Writing deep dives on BGP, eBPF, IPv6  
